...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Situs undangan digital yang menggunakan Laravel. Siap mengudara dalam waktu dekat." />
        <meta name="author" content="Rizvan Primadita" />
    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                @if (Route::has('login'))
                    @auth
                        <li class="sidebar-nav-item"><a href="{{ url('/home') }}">Profile</a></li>
                    @else
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1">Kita Undang</h1>
                <h3 class="mb-5"><em>Situs undangan digital yang menggunakan Laravel</em></h3>
        ...
        <section class="callout">
            <div class="container px-4 px-lg-5 text-center">
                ...
                <a class="btn btn-primary btn-xl" href="https://numerik.id/">Download Now!</a>
            </div>
        </section>
        <!-- Portfolio-->
